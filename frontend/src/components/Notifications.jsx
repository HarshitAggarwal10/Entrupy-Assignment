    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-3xl font-bold text-gray-900">Price Change Notifications</h1>
          <button
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${getEventTypeColor(notification.event_type)}`}>
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-2">Price Change Detected</h3>
                  ...
                  <div className="ml-4 text-right">
                    ...
                    <p className="text-xs text-gray-700 font-mono break-all">{notification.id}</p>
                  </div>
                </div>
              </div>
            ))}
